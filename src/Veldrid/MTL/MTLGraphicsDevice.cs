...
namespace Veldrid.MTL
{
    internal unsafe class MTLGraphicsDevice : GraphicsDevice
    {
        ...
        private readonly IntPtr _libSystemHandle;
            ...
            SwapchainDescription? swapchainDesc)
        {
            ...
            if (!NativeLibrary.TryLoad("libSystem.dylib", out _libSystemHandle))
            {
                throw new PlatformNotSupportedException("Unable to load libSystem.dylib required for Metal block interop.");
            }

            _concreteGlobalBlock = NativeLibrary.GetExport(_libSystemHandle, "_NSConcreteGlobalBlock");
        ...
        protected override void PlatformDispose()
        {
            ...
            NativeLibrary.Free(_libSystemHandle);
